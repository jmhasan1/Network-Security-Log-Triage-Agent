...
from src.network_security.constant.training_pipeline import DATA_INGESTION_COLLECTION_NAME
from src.network_security.constant.training_pipeline import DATA_INGESTION_DATABASE_NAME
...
async def predict_route(request: Request,file: UploadFile = File(...)):
    try:
        ...
        #print(df)
        preprocesor=load_object("model/preprocessor.pkl")
        final_model=load_object("model/model.pkl")
